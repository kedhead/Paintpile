...
export const BADGE_DEFINITIONS: Record<string, Omit<Badge, 'id' | 'createdAt'>> = {
  ...
  ai_explorer: {
    name: 'AI Explorer',
    description: 'Used an AI tool for the first time',
    category: 'special',
    tier: 'bronze',
    icon: '🧪',
    color: '#8e44ad',
    requirement: 'Use AI tools 1 time',
    points: 10,
    trigger_type: 'stat_milestone',
    trigger_field: 'aiActionsUsed',
    trigger_value: 1,
  },
  ai_enthusiast: {
    name: 'AI Enthusiast',
    ...
    icon: '🔮',
    color: '#9b59b6',
    requirement: 'Use AI tools 10 times',
    points: 50,
    trigger_type: 'stat_milestone',
    trigger_field: 'aiActionsUsed',
    trigger_value: 10,
  ...
  ai_power_user: {
    ...
    icon: '⚡',
    color: '#f1c40f',
    requirement: 'Use AI tools 50 times',
    points: 250,
    trigger_type: 'stat_milestone',
    trigger_field: 'aiActionsUsed',
    trigger_value: 50,
